...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscriber.phone_number'
        db.add_column(u'bills_subscriber', 'phone_number',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Subscriber.state'
        db.add_column(u'bills_subscriber', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscriber.security_deposit'
        db.add_column(u'bills_subscriber', 'security_deposit',
    ...
    def backwards(self, orm):
        # Deleting field 'Subscriber.phone_number'
        db.delete_column(u'bills_subscriber', 'phone_number')

        # Deleting field 'Subscriber.state'
        db.delete_column(u'bills_subscriber', 'state')

        # Deleting field 'Subscriber.security_deposit'
        db.delete_column(u'bills_subscriber', 'security_deposit')


        # Changing field 'Subscriber.credit_limit'
        db.alter_column(u'bills_subscriber', 'credit_limit', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        u'bills.booster': {
            ...
            'volume': ('django.db.models.fields.CharField', [], {'default': "':0'", 'max_length': '6', 'null': 'True', 'blank': 'True'})
        },
        u'bills.call': {
