...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Roaming.vol_or_duration'
        db.delete_column(u'bills_roaming', 'vol_or_duration')
        ...
        # Deleting field 'Data.vol_or_duration'
        db.delete_column(u'bills_data', 'vol_or_duration')
        ...
        # Deleting field 'Booster.vol_or_duration'
        db.delete_column(u'bills_booster', 'vol_or_duration')
        ...
        # Deleting field 'Call.vol_or_duration'
        db.delete_column(u'bills_call', 'vol_or_duration')
    ...
    def backwards(self, orm):
        # Adding field 'Roaming.vol_or_duration'
        db.add_column(u'bills_roaming', 'vol_or_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Data.vol_or_duration'
        db.add_column(u'bills_data', 'vol_or_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Booster.vol_or_duration'
        db.add_column(u'bills_booster', 'vol_or_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Call.vol_or_duration'
        db.add_column(u'bills_call', 'vol_or_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
