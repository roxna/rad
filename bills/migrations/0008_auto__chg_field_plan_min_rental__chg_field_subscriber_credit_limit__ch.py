...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plan.min_rental'
        db.alter_column(u'bills_plan', 'min_rental', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Subscriber.credit_limit'
        db.alter_column(u'bills_subscriber', 'credit_limit', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Subscriber.security_deposit'
        db.alter_column(u'bills_subscriber', 'security_deposit', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Plan.min_rental'
        db.alter_column(u'bills_plan', 'min_rental', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

        # Changing field 'Subscriber.credit_limit'
        db.alter_column(u'bills_subscriber', 'credit_limit', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Subscriber.security_deposit'
        db.alter_column(u'bills_subscriber', 'security_deposit', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'bills.plan': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'min_rental': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'bills.subscriber': {
            ...
            'credit_limit': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'security_deposit': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
